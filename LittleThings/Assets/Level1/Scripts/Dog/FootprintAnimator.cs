...
{
    [Header("Footprint Sprite GameObjects")]
    public Footprint footprint_FrontLeft;
    public Footprint footprint_FrontRight;
    public Footprint footprint_RearLeft;
    public Footprint footprint_RearRight;
    ...
    public void AnimateFrontLeft(Vector3 aPosition, Vector3 aRotation)
    {
        footprint_FrontLeft.SetPrint(aPosition, aRotation);
    }
    public void AnimateFrontRight(Vector3 aPosition, Vector3 aRotation)
    {
        footprint_FrontRight.SetPrint(aPosition, aRotation);
    }
    public void AnimateRearLeft(Vector3 aPosition, Vector3 aRotation)
    {
        footprint_RearLeft.SetPrint(aPosition, aRotation);
    }
    public void AnimateRearRight(Vector3 aPosition, Vector3 aRotation)
    {
        footprint_RearRight.SetPrint(aPosition, aRotation);
    }
}
